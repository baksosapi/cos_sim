...
$data_DFi = $cs->getDDFi();
$data_IDF = $cs->getIDF();
$data_W = $cs->getW_TFIDF();
$data_DP = $cs->getDotProd();
$data_VL = $cs->getVectorLength();
$data_CS['RESULT'] = $cs->getCosSim();
$data_SR = $cs->getShowResult();
...
$data = array_merge_recursive($data_TF, $data_DF, $data_DFi,$data_DF, $data_W, $data_DP, $data_VL);
...
<!--        <th colspan="--><?php //echo $cs->num_d+1;?><!--" bgcolor="#ffebcd">Term Frequency</th>-->
<!--        <th rowspan="2">DF</th>-->
<!--        <th rowspan="2">D/DF</th>-->
<!--        <th rowspan="2">idf</th>-->
<!--        <th colspan="--><?php //echo $cs->num_d+1;?><!--" bgcolor="#deb887">W = TFxIDF</th>-->
<!--        <th colspan="--><?php //echo $cs->num_d;?><!--" bgcolor="#6495ed">q x d</th>-->
<!--        <th colspan="--><?php //echo $cs->num_d+1;?><!--" bgcolor="#9acd32">Vector Length</th>-->
<!--    </tr>-->
<!--    <tr>-->
<!--        <th>q</th>-->
<!--        --><?php //for ($i=0;$i<$cs->num_d;$i++){
//            echo '<th>d'.$i.'</th>';
//        }?>
...
<!--<table border="1">-->
<!--    --><?php //array_walk($data_SR, 'print_list');?>
<!--</table>-->
...
//        $this->data = $this->data_table->data;
//        print_r($this->data_table->num_d);

//        $this->data = $this->data_table->
